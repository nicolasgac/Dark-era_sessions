...
\institute[]{Daniel Charlet$^{**5}$ (IJCLab), Karol Desnos$^{1}$, Mickael Dardaillon$^{3}$, André Ferrari$^{4}$, Chiara Ferrari$^{4}$, Nicolas Gac$^{3}$, Jean-François Nezan$^{1}$, François Orieux$^{3}$, Simon Prunet$^{4}$, \textcolor{gray}{Martin Quinson$^{2}$}, \textcolor{gray}{Frédéric Suter$^{**2}$(IN2P3 Computing Center)}, Cyril Tasse$^{**5}$ (GEPI), Cédric Viou$^{5}$ }
...
\frame{
\frametitle{Séminaires Cédric+Cyril sur les \textbf{Instruments}}

\begin{block}{Cédric}
    \begin{itemize}
        \item Slides : \small{\href{https://mycore.core-cloud.net/index.php/s/5BCCIr8gZmEKjqH}{\color{blue}https://mycore.core-cloud.net/index.php/s/5BCCIr8gZmEKjqH}}
        \item Video : \small{\href{https://mycore.core-cloud.net/index.php/s/mayu0Zh1BW3v6Z7}{\color{blue}https://mycore.core-cloud.net/index.php/s/mayu0Zh1BW3v6Z7}}
        \end{itemize}
\end{block}

\begin{block}{Cyril}
    \begin{itemize}
        \item Video : \small{\href{https://mycore.core-cloud.net/index.php/s/MQXN534jYV73lnu}{\color{blue}https://mycore.core-cloud.net/index.php/s/MQXN534jYV73lnu}}
        \end{itemize}
\end{block}
...
\begin{block}{Amorce de cahier des charges}
   \begin{itemize}
       ...
       \item Un \textbf{wiki} (\textit{merci François pour la suggestion}) est mis en place sur le gitlab de dark-era pour poursuivre ce travail : \\
   \end{itemize}  
